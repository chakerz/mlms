   ...
   aria-invalid:border-destructive/60 aria-invalid:ring-destructive/10`,
  {
    variants: {
      size: {
        ...
        md: 'h-8.5 px-3 text-[0.8125rem] gap-1 rounded-md',
  ...
  return (
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        ...
        className={cn(
          'relative z-50 max-h-96 min-w-[8rem] overflow-hidden rounded-md border border-border bg-popover shadow-md shadow-black/5 text-secondary-foreground',
