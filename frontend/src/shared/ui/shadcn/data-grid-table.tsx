...
function DataGridTableBase({ children, dir }: { children: ReactNode; dir?: string }) {
...
function DataGridTableHeadRowCell<TData>({
  ...
  return (
    <th
      key={header.id}
      style={{
        ...(props.tableLayout?.width === 'fixed' && { width: `${header.getSize()}px` }),
      ...
      className={cn(
        ...
        props.tableLayout?.columnsPinnable &&
          column.getCanPin() &&
          '[&[data-pinned=left][data-last-col=left]]:border-e! [&[data-pinned=right][data-last-col=right]]:border-s! [&[data-pinned][data-last-col]]:border-border data-pinned:bg-muted/90 data-pinned:backdrop-blur-xs',
...
function DataGridTable<TData>() {
  ...
  const dir =
    typeof document !== 'undefined' ? (document.documentElement.dir as 'ltr' | 'rtl') : undefined

  return (
    <DataGridTableBase dir={dir}>
      <DataGridTableHead>
      ...
      <DataGridTableBody>
        {isLoading ? (
          <tr>
            <td colSpan={table.getAllColumns().length} className="text-center text-muted-foreground py-6">
