...
const tabsListVariants = cva('flex items-center shrink-0', {
  ...
  compoundVariants: [
    { variant: 'default', size: 'lg', className: 'p-1.5 gap-2.5 rounded-lg' },
    { variant: 'default', size: 'md', className: 'p-1 gap-2 rounded-lg' },
    { variant: 'default', size: 'sm', className: 'p-1 gap-1.5 rounded-md' },
    { variant: 'default', size: 'xs', className: 'p-1 gap-1 rounded-md' },
  ...
  'shrink-0 cursor-pointer whitespace-nowrap inline-flex justify-center items-center font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:shrink-0 [&_svg]:text-muted-foreground [&:hover_svg]:text-primary [&[data-state=active]_svg]:text-primary',
  {
    variants: {
      variant: {
        ...
        button:
          'text-accent-foreground hover:text-foreground data-[state=active]:bg-accent data-[state=active]:text-foreground rounded-lg',
    ...
    compoundVariants: [
      ...
      { variant: 'button', size: 'lg', className: 'py-3 px-4' },
...
const TabsContext = React.createContext<TabsContextType>({ variant: 'default', size: 'md' })
