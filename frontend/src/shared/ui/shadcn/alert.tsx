...
const alertVariants = cva('flex items-stretch w-full gap-2', {
  ...
  compoundVariants: [
    ...
    { variant: 'success', appearance: 'outline', className: 'border border-border bg-background text-[var(--color-success,var(--color-green-500))]' },
    { variant: 'info', appearance: 'outline', className: 'border border-border bg-background text-[var(--color-info,var(--color-violet-600))]' },
    { variant: 'warning', appearance: 'outline', className: 'border border-border bg-background text-[var(--color-warning,var(--color-yellow-500))]' },
  ...
  defaultVariants: { variant: 'secondary', appearance: 'solid', size: 'md' },
})
    ...
    >
      ...
      {close && (
        <Button
          ...
          className="group shrink-0 size-4"
        >
...
function AlertToolbar({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) {
...
function AlertContent({ className, ...props }: React.HTMLAttributes<HTMLParagraphElement>) {
  return (
    <div data-slot="alert-content" className={cn('space-y-1 [&_[data-slot=alert-title]]:font-semibold', className)} {...props} />
  )
}
